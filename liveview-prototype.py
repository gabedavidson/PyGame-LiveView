...
class Environment:
    ...
    def change_env_dimensions(self, active_zones_across_inset, active_zones_down_inset, active_zones_across, active_zones_down):
        assert 0 < active_zones_across <= self.default_zones_across and 0 < active_zones_down <= self.default_zones_down
        self.active_zones_across = active_zones_across if self.default_zones_across - active_zones_across_inset >= active_zones_across else self.default_zones_across - active_zones_across_inset
        self.active_zones_down = active_zones_down if self.default_zones_down - active_zones_down_inset >= active_zones_down else self.default_zones_down - active_zones_down_inset
